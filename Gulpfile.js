...
gulp.task('build', ['clean', 'image-min', 'sass', 'css-libs', 'js-libs'],() => {       // Таск який відповідає за мініфіковані img, css... які підуть в продакшн
